 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Nov 05 19:24:09 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                ekf_predictive
...
#define INPUT_0_DIMS_ND                {2,1}
#define INPUT_0_NUM_ELEMS              2
...
extern void ekf_predictive_Outputs_wrapper(const real_T *u,
  const real_T *R,
  const real_T *L,
  const real_T *Ke,
  const real_T *J,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u of S-Function ekf_predictive");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port R of S-Function ekf_predictive");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port L of S-Function ekf_predictive");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Ke of S-Function ekf_predictive");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port J of S-Function ekf_predictive");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Nr of S-Function ekf_predictive");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Ts of S-Function ekf_predictive");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port x_pred_out of S-Function ekf_predictive");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real_T *L = (real_T *) ssGetInputPortRealSignal(S, 2);
  const real_T *Ke = (real_T *) ssGetInputPortRealSignal(S, 3);
  const real_T *J = (real_T *) ssGetInputPortRealSignal(S, 4);
  const real_T *Nr = (real_T *) ssGetInputPortRealSignal(S, 5);
  const real_T *Ts = (real_T *) ssGetInputPortRealSignal(S, 6);
  real_T *x_pred_out = (real_T *) ssGetOutputPortRealSignal(S, 0);
  ekf_predictive_Outputs_wrapper(u, R, L, Ke, J, Nr, Ts, x_pred_out);
}
