...
Fmax = 2000;
plot = 1;
out_Ia_M0 = fft_analyzer(Ia_planta_M0, 'Name',"Ia_M0", 'MaxPeaks',20, 'MinPeakFrac',0.05,'Fref',fe_ref,'Fmax',Fmax,'Kmax',Kmax,'TimeWindow',[t_inicial t_final],'DoPlot',plot);
out_Ib_M0 = fft_analyzer(Ib_planta_M0, 'Name',"Ib_M0", 'MaxPeaks',20, 'MinPeakFrac',0.05,'Fref',fe_ref,'Fmax',Fmax,'Kmax',Kmax,'TimeWindow',[t_inicial t_final],'DoPlot',plot);
...
%%En rad/s
out_We_M0 = fft_analyzer(We_planta_M0, 'Name',"We_M0", 'MaxPeaks',20, 'MinPeakFrac',0.05,'Fref',fe_ref,'Fmax',Fmax,'Kmax',Kmax,'TimeWindow',[t_inicial t_final],'DoPlot',plot);
...
fe_M0 = We_planta_M0.mean/(2*pi);
fe_M1 = We_planta_M1.mean/(2*pi);
fe_M2 = We_planta_M2.mean/(2*pi);
%%En rad/s
out_Wm_M0 = fft_analyzer(Wm_planta_M0, 'Name',"Wm_M0", 'MaxPeaks',20, 'MinPeakFrac',0.05,'Fref',fe_ref,'Fmax',Fmax,'Kmax',Kmax,'TimeWindow',[t_inicial t_final],'DoPlot',plot);
...
out_Te_M0 = fft_analyzer(Te_planta_M0, 'Name',"Te_M0", 'MaxPeaks',20, 'MinPeakFrac',0.05,'Fref',fe_ref,'Fmax',Fmax,'Kmax',Kmax,'TimeWindow',[t_inicial t_final],'DoPlot',plot);
...
fprintf("fe_ref M0 = %.3f Hz |fe_ref M1 = %.3f Hz | fe_ref M2 = %.3f Hz\n",fe_M0, fe_M1, fe_M2);

fprintf("THD Ia M0 = %.2f %%\n", 100*out_Ia_M0.THD);
fprintf("THD Ib M0 = %.2f %%\n", 100*out_Ib_M0.THD);
...
T_Ia = table_fund_and_3harm( ...
    {out_Ia_M0,out_Ib_M0,out_Ia_M1, out_Ib_M1,out_Ia_M2, out_Ib_M2}, ...
    {'Ia M0','Ib M0','Ia M1','Ib M1','Ia M2','Ib M2'});
...
T_Te = table_fund_and_3harm( ...
    {out_Te_M0,out_Te_M1, out_Te_M2}, ...
    {'Te M0','Te M1','Te M2'});

disp(T_Te)

fprintf("mean Te M0 = %.2f \n", out_Te_M0.mean);
fprintf("mean Te M1 = %.2f \n", out_Te_M1.mean);
fprintf("mean Te M2 = %.2f \n", out_Te_M2.mean);
fprintf("ripple P-P Te M0 = %.2f \n", out_Te_M0.ripple_pp);
fprintf("ripple P-P Te M1 = %.2f \n", out_Te_M1.ripple_pp);
fprintf("ripple P-P Te M2 = %.2f \n", out_Te_M2.ripple_pp);
fprintf("ripple rms Te M0 = %.2f \n", out_Te_M0.ripple_rms_ac);
fprintf("ripple rms Te M1 = %.2f \n", out_Te_M1.ripple_rms_ac);
fprintf("ripple rms Te M2 = %.2f \n", out_Te_M2.ripple_rms_ac);
fprintf("Max M0= %.4f en t = %.6f s\n", out_Te_M0.extrema.max, out_Te_M0.extrema.t_max);
...
fprintf("Min M0= %.4f en t = %.6f s\n", out_Te_M0.extrema.min, out_Te_M0.extrema.t_min);
...
fprintf("P-P raw M0= %.4f\n", out_Te_M0.extrema.pp_raw);
fprintf("P-P raw M1= %.4f\n", out_Te_M1.extrema.pp_raw);
fprintf("P-P raw M2= %.4f\n", out_Te_M2.extrema.pp_raw);
fprintf("P-P robust M0= %.4f\n", out_Te_M0.ripple_pp_robust);
