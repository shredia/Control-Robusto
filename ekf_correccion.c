 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Nov 05 19:16:57 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                ekf_correccion
...
extern void ekf_correccion_Outputs_wrapper(const real_T *id_meas,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port id_meas of S-Function ekf_correccion");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port iq_meas of S-Function ekf_correccion");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function ekf_correccion");
      return;
    }
...
{
  const real_T *id_meas = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *iq_meas = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *y0 = (real_T *) ssGetOutputPortRealSignal(S, 0);
  ekf_correccion_Outputs_wrapper(id_meas, iq_meas, y0);
}
