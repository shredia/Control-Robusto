 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Oct 20 13:17:04 2025
 */
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Id_ref of S-Function PI_dq");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Iq_ref of S-Function PI_dq");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real_T *Id_ref = (real_T *) ssGetInputPortRealSignal(S, 2);
  const real_T *Iq_ref = (real_T *) ssGetInputPortRealSignal(S, 3);
  ...
  const real_T *Wm_ext = (real_T *) ssGetInputPortRealSignal(S, 14);
  ...
  PI_dq_Outputs_wrapper(Ia, Ib, Id_ref, Iq_ref, Kp_current, Ki_current,
                        Kd_current, sample_time_ext, Vdc_ext, R_ext, Ld_ext,
                        Lq_ext, Ke_ext, Theta_ext, Wm_ext, Ud, Uq, Id, Iq);
}
