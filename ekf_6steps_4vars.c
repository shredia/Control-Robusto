 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Nov 21 11:56:13 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                ekf_6steps_4vars
...
extern void ekf_6steps_4vars_Start_wrapper(void);
extern void ekf_6steps_4vars_Outputs_wrapper(const real_T *Va,
  const real_T *Vb,
  const real_T *R,
  const real_T *L,
  const real_T *Kt,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Va of S-Function ekf_6steps_4vars");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vb of S-Function ekf_6steps_4vars");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port R of S-Function ekf_6steps_4vars");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port L of S-Function ekf_6steps_4vars");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Kt of S-Function ekf_6steps_4vars");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port J of S-Function ekf_6steps_4vars");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Ts of S-Function ekf_6steps_4vars");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Ia_medido of S-Function ekf_6steps_4vars");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Ib_medido of S-Function ekf_6steps_4vars");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Nr of S-Function ekf_6steps_4vars");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port x_corr_out of S-Function ekf_6steps_4vars");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  ekf_6steps_4vars_Outputs_wrapper(Va, Vb, R, L, Kt, J, Ts, Ia_medido, Ib_medido,
    Nr, x_corr_out);
}
