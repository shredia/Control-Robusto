 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Sep 07 20:26:01 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                back_emf
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                theta_e
...
/* Output Port  2 */
#define OUT_PORT_2_NAME                dot_w_e
...
extern void back_emf_Outputs_wrapper(const real_T *Valpha,
  const real_T *Vbetha,
  const real_T *Ialpha,
  const real_T *Ibetha,
  real_T *theta_e,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Valpha of S-Function back_emf");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vbetha of S-Function back_emf");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Ialpha of S-Function back_emf");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Ibetha of S-Function back_emf");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port theta_e of S-Function back_emf");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port w_e of S-Function back_emf");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port dot_w_e of S-Function back_emf");
      return;
    }
...
{
  const real_T *Valpha = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *Vbetha = (real_T *) ssGetInputPortRealSignal(S, 1);
  const real_T *Ialpha = (real_T *) ssGetInputPortRealSignal(S, 2);
  const real_T *Ibetha = (real_T *) ssGetInputPortRealSignal(S, 3);
  real_T *theta_e = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *w_e = (real_T *) ssGetOutputPortRealSignal(S, 1);
  real_T *dot_w_e = (real_T *) ssGetOutputPortRealSignal(S, 2);
  back_emf_Outputs_wrapper(Valpha, Vbetha, Ialpha, Ibetha, theta_e, w_e, dot_w_e);
}
