...
PRODUCT_NAME              = Simulacion_stepper
MAKEFILE                  = Simulacion_stepper.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2024a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2024a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = D:\Utal\Memoria_Clinostato\Memoria-clinostato\Control Robusto
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Simulacion_stepper_comp.rsp
CMD_FILE                  = Simulacion_stepper.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Simulacion_stepper.exe
...
DEFINES_STANDARD = -DMODEL=Simulacion_stepper -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
{$(MATLAB_ROOT)\toolbox\physmod\powersys\powersys}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(MATLAB_ROOT)\toolbox\physmod\powersys\powersys}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
{$(START_DIR)\Simulacion_stepper_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Simulacion_stepper_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Simulacion_stepper_grt_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Simulacion_stepper_grt_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Simulacion_stepper.obj : "$(START_DIR)\Simulacion_stepper_grt_rtw\Simulacion_stepper.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Simulacion_stepper_grt_rtw\Simulacion_stepper.c"


Simulacion_stepper_data.obj : "$(START_DIR)\Simulacion_stepper_grt_rtw\Simulacion_stepper_data.c"
...
rt_nonfinite.obj : "$(START_DIR)\Simulacion_stepper_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Simulacion_stepper_grt_rtw\rt_nonfinite.c"
